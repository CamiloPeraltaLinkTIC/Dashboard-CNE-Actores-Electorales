...
import { saveDailyActualsAction } from "@/app/(shell)/pauta/actions";
import { CHANNELS } from "@/lib/campana/constants";
import { formatDate } from "@/lib/campana/format";
import type { DailyActuals, DailyPlan } from "@/lib/campana/types";
  ...
  return (
    <form action={formAction}>
      ...
      <div className="mt-4 flex items-center justify-between">
        <p className="text-xs text-[var(--text-faint)]">Valores en COP. Deja en 0 los días sin datos reales aún.</p>
        <SubmitButton />
      </div>
    </form>
  );
